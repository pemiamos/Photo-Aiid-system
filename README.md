...
## 🎚️ 两种使用模式（v3.3 新增，一键切换）

同一个 App，按你的角色选模式——顶部一键切换，重启自动记住上次选择。

### 🙂 普通用户版（默认）
**为「我只想把自己电脑里的照片整理好」的人准备。** 界面干净，没有任何投稿/征稿的复杂概念，开箱即用：

- 选个文件夹就能扫描，AI 自动分类打标、认出摄影师与拍摄地点
- 「历史索引」跨全库秒搜——不用记照片存哪了，输关键词即出
- 一键批量重命名、CSV 导出、缩略图拖到桌面即取原图
- 全程本地，可用免费/本地引擎，隐私优先

> 适合：摄影爱好者、需要整理海量素材的个人、不关心投稿协作的用户。

### 📷 高级摄影师版（点「切换到高级摄影师版」解锁）
**在普通版全部功能之上，解锁多人征稿与云端协作的完整工作流：**

- **网页征稿**：摄影师凭投稿码打开专属链接/扫码即可上传，无需装软件，照片浏览器直传云端
- **云端投稿管理**：建书籍项目、发投稿码、征稿看板（已交/未交统计、缩略图下钻、催稿名单）
- **照片管理**：从看板选片归入相册、整包 ZIP 下载，直接进入排版流程
- **OSS 主存 + Cloudflare R2 异地备份**，按书停止征稿、独立投稿码前缀

> 适合：画册/选题的组稿人、需要向多位摄影师征集照片并统一管理的团队。
